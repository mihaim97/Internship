...
drop table if exists internship.user;
...
insert into internship.`user` (username, password) values ('mihai',
 '$2a$10$ZyYIZn6yS8qzNVBJPJGTbOjzR4j/z6j4JY8oinVJjEYROsw.MUwX.'); # mihai parola
insert into internship.`user` (username, password) values ('ana',
 '$2a$10$V76UeyA9HUjPU0ermY5X6OnguD7t2n7fpenzZmIvwJ7hgi2d56w6.'); # ana parola
insert into internship.`user` (username, password) values ('user',
