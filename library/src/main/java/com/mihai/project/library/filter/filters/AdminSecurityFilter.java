...
import com.mihai.project.library.util.enumeration.LibraryRole;
...
public class AdminSecurityFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (user != null) {
            if (user.getRole().toLowerCase().equals(LibraryRole.ADMIN.toString().toLowerCase())) {
        ...
        outputStream.write(messageBuilder.asJSON(ExceptionMessage.BAD_CREDENTIALS).getBytes());
    }
